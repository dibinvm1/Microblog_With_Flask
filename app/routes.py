...
from app.forms import LoginForm, RegristrationForm, EditProfileForm, EmptyForm, PostForm, ResetPasswordRequestForm, ResetPasswordForm
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        if usr:
            ...
            flash('Check Your email for the instructins to reset your password!')
            return redirect(url_for('login'))
        flash('User Not Found.Plsease use the correct email!!')
